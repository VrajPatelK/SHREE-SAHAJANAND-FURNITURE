...
const CustomerSchema = new mongoose.Schema({
    ...
    customer_mobile: { type: Number, minlength: [10, "Mobile number must be of 10 digits"], maxlength: [10, "Mobile number must be of 10 digits"] },
    customer_homeNo: { type: Number, },
    customer_street: { type: String, },
    customer_pincode: { type: Number, minlength: 6, maxlength: 6 },
    customer_district: { type: String, },
